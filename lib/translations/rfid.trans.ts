...
export const rfidTranslations = {
  ...
  en: {
    ...
    intro: {
      ...
      title1: "Vehicle billing system for food waste for Businesses",
      ...
      steps: [
        {
          ...
          description: "[Vehicle billing system for food waste, Patent No. 10-2582620]",
    ...
    // 결제시스템 구성도 섹션
    systemDiagram: {
      title: "Collection Vehicle billing system for food waste Payment System Configuration",
      ...
      diagramAlt: "CODA RFID Food Waste Collection Payment System - Collection Vehicle billing system for food waste Payment System Configuration",
