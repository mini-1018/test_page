...
export const compressorTranslations = {
  ko: {
    ...
    metaData: {
      ...
      image: "/images/item_coda_coda/coda_coda_s3.webp",
      openGraph: {
        siteName: "코다(CODA)",
        locale: "ko_KR",
      },
...
export function getCompressorTranslations(locale: Locale = "ko") {
  return createTranslator(compressorTranslations, locale);
}
