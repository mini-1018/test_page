export const metaData = {
  home: {
    ...
    canonical: "https://www.coda.ai.kr/",
    keywords: ["지테크", "코다", "CODA", "재활용", "친환경", "무인회수기", "음식물종량기", "RFID"],
  },
  brand: {
    title: "코다(CODA) 브랜드 소개",
    description: "코다(CODA)는 자원 선순환 플랫폼으로, 무인회수기와 음식물종량기, RFID 기술을 통해 지속 가능한 환경을 지향합니다.",
    alternates: {
      canonical: "https://www.coda.ai.kr/brand",
    },
    keywords: ["코다", "CODA", "브랜드", "무인회수기", "음식물 종량기", "RFID"],
  },
  recycleMachine: {
    title: "코다(CODA) 무인회수기",
