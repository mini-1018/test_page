      ...
      <div className="max-w-full mx-auto">
        ...
        <div className="w-full bg-[#f5f6f9]">
          <div className="py-[150px] px-4 max-w-7xl mx-auto">
            ...
            <div className="text-[26px] font-light text-[#656565]">
              동일한 500ml PET 500개 기준
              <br />
              압축기와 파쇄기 적재량 비교
            </div>
            <img
              className="w-[500px] h-auto pt-[30px] pb-[120px]"
        ...
        <div className="w-full bg-[#f5f6f9]">
          <div className="py-[150px] px-4 pb-[30px] max-w-7xl mx-auto">
            <FeatureItem
              ...
              imageSrc="https://do40f6yw4fd7i.cloudfront.net/img13/item_coda_crush/coda_crush_s9_6.webp"
