        ...
        <div className="w-full overflow-hidden relative flex flex-col gap-4 md:gap-10">
          ...
          <div className="flex carousell-scroll-left">
            <div className="flex-shrink-0 w-[1024px] lg:w-[1980px]">
              <Image src="https://do40f6yw4fd7i.cloudfront.net/img13/coda_fwd_01.webp" width={1980} height={61} alt="스크롤 이미지" className="w-full h-[31.72px] md:h-[61.36px] object-cover" />
            </div>
            <div className="flex-shrink-0 w-[1024px] lg:w-[1980px]">
              <Image src="https://do40f6yw4fd7i.cloudfront.net/img13/coda_fwd_01.webp" width={1980} height={61} alt="스크롤 이미지" className="w-full h-[31.72px] md:h-[61.36px] object-cover" />
            </div>
          ...
          <div className="flex carousell-scroll-right_40s">
            <div className="flex-shrink-0 w-[1024px] lg:w-[1980px]">
              <Image src="https://do40f6yw4fd7i.cloudfront.net/img13/coda_fwd_02.webp" width={1980} height={61} alt="스크롤 이미지" className="w-full h-[31.72px] md:h-[61.36px] object-cover" />
            </div>
            <div className="flex-shrink-0 w-[1024px] lg:w-[1980px]">
              <Image src="https://do40f6yw4fd7i.cloudfront.net/img13/coda_fwd_02.webp" width={1980} height={61} alt="스크롤 이미지" className="w-full h-[31.72px] md:h-[61.36px] object-cover" />
            </div>
          ...
          <div className="flex carousell-scroll-left_40s">
            <div className="flex-shrink-0 w-[1024px] lg:w-[1980px]">
              <Image src="https://do40f6yw4fd7i.cloudfront.net/img13/coda_fwd_03.webp" width={1980} height={61} alt="스크롤 이미지" className="w-full h-[31.72px] md:h-[61.36px] object-cover" />
            </div>
            <div className="flex-shrink-0 w-[1024px] lg:w-[1980px]">
              <Image src="https://do40f6yw4fd7i.cloudfront.net/img13/coda_fwd_03.webp" width={1980} height={61} alt="스크롤 이미지" className="w-full h-[31.72px] md:h-[61.36px] object-cover" />
            </div>
