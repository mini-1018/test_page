  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-full flex flex-col text-center">
        {/* 헤더 섹션 */}
        <div className="w-full">
          <Image src="/images/item_coda_esg/coda_esg_s1.webp" alt={t("header.mainAlt")} className="w-full h-auto pt-[64px] md:pt-[80px]" width={1920} height={800} priority={true} />
        </div>
          ...
          <div className="w-full py-[75px] md:py-[150px]">
            <div className="max-w-7xl mx-auto px-4">
              <div className="mb-[30px]">
                <Image className="mx-auto w-[80px] md:w-[160px]" src="/images/item_coda_esg/coda_esg_s2.webp" alt={t("intro.alt")} width={160} height={180} />
              </div>
              <div>
        ...
        <FadeUpOnView>
          <div className="w-full">
            <Image className="w-full h-auto" src="/images/item_coda_esg/coda_esg_s3.webp" alt={t("header.subAlt")} width={1920} height={800} />
          </div>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <FeatureSection bgColor="bg-[#f5f6f9]" title={t("co2Reduction.title")} description={t("co2Reduction.description")}>
            <div className="max-w-[840px] bg-[#f5f6f9] flex flex-col items-center">
              <Image className="mb-5 w-full" src="/images/item_coda_esg/coda_esg_s4.webp" alt={t("co2Reduction.alt")} width={840} height={800} />
        ...
        <FadeUpOnView>
          <FeatureSection title={t("features.mainTitle")} description={t("features.mainDescription")}>
            <Image className="mx-auto sm:w-[60%] min-w-[300px]" src="/images/item_coda_esg/coda_esg_s5.webp" alt={t("features.alt")} width={800} height={800} />
          </FeatureSection>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <div className="w-full">
            <Image className="w-full h-auto" src="/images/item_coda_esg/coda_esg_s6.webp" alt={t("header.subAlt")} width={1920} height={800} />
          </div>
        </FadeUpOnView>
        ...
        <NumberedSection number="1" title={t("section1.title")} bgColor="bg-[#f5f6f9]">
          <div className="w-full bg-[#f5f6f9]">
            <div className="py-[20px] px-4 mx-auto">
              <FadeUpOnView>
                <Image src="/images/common/icon_ai.webp" alt={t("section1.aiIconAlt")} className="mb-[50px] m-auto" width={80} height={60} />
                <div className="text-[14px] md:text-[20px] font-light text-[#656565] mb-[100px] whitespace-pre-line">{t("section1.description")}</div>
              </FadeUpOnView>

              <FadeUpOnView>
                <FeatureItem title={t("section1.features.0.title")} description={t("section1.features.0.description")} imageSrc="/images/item_coda_esg/coda_coda_s9_1.webp" alt={t("section1.features.0.alt")} />
              </FadeUpOnView>

              <FadeUpOnView>
                <FeatureItem title={t("section1.features.1.title")} description={t("section1.features.1.description")} imageSrc="/images/item_coda_esg/coda_coda_s9_2.webp" alt={t("section1.features.1.alt")} />
              </FadeUpOnView>

              <FadeUpOnView>
                <FeatureItem title={t("section1.features.2.title")} description={t("section1.features.2.description")} imageSrc="/images/item_coda_coda/coda_coda_s9_6.webp" alt={t("section1.features.2.alt")} />
              </FadeUpOnView>
            </div>
          </div>
        </NumberedSection>
        ...
        <FadeUpOnView>
          <NumberedSection number="2" title={t("section2.title")}>
            <Image className="w-[700px] h-auto mx-auto pt-[30px] pb-[30px]" src="/images/item_coda_esg/coda_esg_s7_1.webp" alt={t("section2.usageAlt")} width={700} height={500} />
            ...
            <Image className="pt-[30px] pb-[30px] m-auto" src="/images/item_coda_esg/coda_esg_s6_2.webp" alt={t("section2.convenienceAlt")} width={400} height={300} />
            ...
            <Image className="m-auto pt-[30px] pb-[80px]" src="/images/item_coda_esg/coda_esg_s6_3.webp" alt={t("section2.safetyAlt")} width={800} height={600} />
          </NumberedSection>
        </FadeUpOnView>
          ...
          <NumberedSection number="3" title={t("section3.title")} bgColor="bg-[#f5f6f9]">
            <div className="w-full bg-[#f5f6f9]">
              <div className="py-[20px] px-4 max-w-7xl mx-auto">
                <Image className="mx-auto pt-[30px] pb-[30px]" src="/images/item_coda_esg/coda_esg_s7_3.webp" alt={t("section3.alt")} width={500} height={400} />
        ...
        <FadeUpOnView>
          <NumberedSection number="4" title={t("section4.title")}>
            <Image className="w-[500px] h-auto mx-auto pt-[30px] pb-[30px]" src="/images/item_coda_esg/coda_esg_s7_4.webp" alt={t("section4.systemAlt")} width={500} height={400} />
            ...
            <Image className="pb-[10px] m-auto" src="/images/item_coda_esg/coda_esg_s7_5.webp" alt={t("section4.qrAlt")} width={100} height={100} />
          </NumberedSection>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <div className="w-full bg-[#f5f6f9]">
            <div className="py-[150px] px-4 pb-[30px] max-w-7xl mx-auto">
              <FeatureItem title={t("canopy.title")} description={t("canopy.description")} imageSrc="/images/item_coda_esg/coda_esg_s7_8.webp" alt={t("canopy.alt")} />
            </div>
          </div>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <div className="w-full">
            <Image className="w-full h-auto" src="/images/item_coda_esg/coda_esg_s8.webp" alt={t("header.finalAlt")} width={1920} height={800} />
          </div>
        </FadeUpOnView>
      </div>
    </div>
