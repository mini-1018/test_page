  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-full mx-auto text-center">
        {/* 헤더 섹션 */}
        <div className="w-full">
          <Image src="/images/item_coda_coda/coda_coda_s1.webp" alt={t("header.mainAlt")} className="w-full h-auto pt-[64px] md:pt-[80px]" width={1920} height={800} priority={true} />
        </div>
          ...
          <div className="w-full py-[75px] md:py-[150px]">
            <div className="max-w-7xl mx-auto px-4">
              <div className="mb-[30px]">
                <Image className="mx-auto w-[80px] md:w-[160px]" src="/images/item_coda_coda/coda_coda_s2.webp" alt={t("intro.alt")} width={160} height={180} />
              </div>
              <div>
        ...
        <FadeUpOnView>
          <div className="w-full">
            <Image className="w-full h-auto" src="/images/item_coda_coda/coda_coda_s3.webp" alt={t("header.subAlt")} width={1920} height={800} />
          </div>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <FeatureSection bgColor="bg-[#f5f6f9]" title={t("features.mainTitle")} description={t("features.mainDescription")}>
            <Image className="mx-auto sm:w-[60%] min-w-[300px]" src="/images/item_coda_coda/coda_coda_s4.webp" alt={t("features.alt")} width={800} height={800} />
          </FeatureSection>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <NumberedSection number="1" title={t("section1.title")}>
            <Image className="pt-[30px] pb-[80px] m-auto" src="/images/item_coda_coda/coda_coda_s5.webp" alt={t("section1.alt")} width={750} height={600} />
        ...
        <NumberedSection number="2" title={t("section2.title")} bgColor="bg-[#f5f6f9]">
          <div className="w-full bg-[#f5f6f9]">
            <div className="py-[20px] px-4 mx-auto">
              ...
              <FadeUpOnView>
                <FeatureItem title={t("section2.features.0.title")} description={t("section2.features.0.description")} imageSrc="/images/item_coda_coda/coda_coda_s9_1.webp" alt={t("section2.features.0.alt")} />
              </FadeUpOnView>

              <FadeUpOnView>
                <FeatureItem title={t("section2.features.1.title")} description={t("section2.features.1.description")} imageSrc="/images/item_coda_coda/coda_coda_s9_2.webp" alt={t("section2.features.1.alt")} />
              </FadeUpOnView>

              <FadeUpOnView>
                <FeatureItem title={t("section2.features.2.title")} description={t("section2.features.2.description")} imageSrc="/images/item_coda_coda/coda_coda_s9_6.webp" alt={t("section2.features.2.alt")} />
              </FadeUpOnView>

              <FadeUpOnView>
                <FeatureItem title={t("section2.features.3.title")} description={t("section2.features.3.description")} imageSrc="/images/item_coda_coda/coda_coda_s9_4.webp" alt={t("section2.features.3.alt")} />
              </FadeUpOnView>
            </div>
          </div>
        </NumberedSection>
        ...
        <FadeUpOnView>
          <NumberedSection number="3" title={t("section3.title")}>
            <Image className="pt-[30px] pb-[40px] md:pb-[80px] m-auto" src="/images/item_coda_coda/coda_coda_s6_1.webp" alt={t("section3.usageAlt")} width={1000} height={800} />
            ...
            <Image className="mx-auto pt-[30px] pb-[80px]" src="/images/item_coda_coda/coda_coda_s6_2.webp" alt={t("section3.convenienceAlt")} width={400} height={300} />
            ...
            <Image className="m-auto pt-[30px] pb-[80px]" src="/images/item_coda_coda/coda_coda_s6_3.webp" alt={t("section3.safetyAlt")} width={800} height={600} />
          </NumberedSection>
        </FadeUpOnView>
          ...
          <NumberedSection number="4" title={t("section4.title")} bgColor="bg-[#f5f6f9]">
            <div className="w-full bg-[#f5f6f9]">
              <div className="py-[20px] px-4 max-w-7xl mx-auto">
                ...
                <Image className="pt-[30px] mb-[100px] md:mb-[200px] m-auto" src="/images/item_coda_coda/coda_coda_s7_1.webp" alt={t("section4.rewardAlt")} width={800} height={600} />
                ...
                <Image className="pt-[30px] pb-[120px] m-auto" src="/images/item_coda_coda/coda_coda_s7_2.webp" alt={t("section4.appAlt")} width={800} height={600} />
                <div className="text-[18px] md:text-[26px] font-bold text-[#0095d3] mb-[10px]">{t("section4.qrTitle")}</div>
                <Image className="pt-[30px] pb-[10px] m-auto" src="/images/item_coda_coda/coda_coda_s7_3.webp" alt={t("section4.qrAlt")} width={100} height={100} />
              </div>
            </div>
          </NumberedSection>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <NumberedSection number="5" title={t("section5.title")}>
            <Image className="pt-[30px] m-auto" src="/images/item_coda_coda/coda_coda_s8.webp" alt={t("section5.alt")} width={700} height={600} />
          </NumberedSection>
        </FadeUpOnView>
        ...
        <FadeUpOnView>
          <div className="w-full">
            <Image className="w-full h-auto" src="/images/item_coda_coda/coda_coda_s11.webp" alt={t("header.finalAlt")} width={1920} height={800} />
          </div>
        </FadeUpOnView>
      </div>
    </div>
