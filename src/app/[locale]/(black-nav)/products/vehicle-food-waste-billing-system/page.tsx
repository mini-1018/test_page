  ...
  return (
    <div className="w-full">
      ...
      <div className="max-w-full mx-auto">
        {/* 헤더 섹션 */}
        <div className="w-full">
          <Image src="/images/item_rfid/coda_rfid_s1_text.webp" alt={t("header.mainAlt")} width={1920} height={600} className="w-full h-auto mt-[80px]" priority={true} />
        </div>
          ...
          <div className="w-full mt-[120px] mb-[120px] md:mt-[240px] md:mb-[240px]">
            <div className="max-w-7xl mx-auto px-4">
              <div className="mb-[20px] md:mb-[30px] flex justify-center">
                <Image className="w-[20%] h-auto" src="/images/item_rfid/coda_rfid_s2.webp" alt={t("intro.iconAlt")} width={400} height={200} />
              </div>
        ...
        <FadeUpOnView>
          <div className="w-full">
            <Image className="w-full h-auto" src="/images/item_rfid/coda_rfid_s3.webp" alt={t("header.subAlt")} width={1920} height={600} />
          </div>
        </FadeUpOnView>
          ...
          <div className="flex flex-col justify-center w-full bg-[#f5f6f9]">
            <div className="py-[75px] md:py-[150px] px-4 max-w-7xl mx-auto text-center">
              ...
              <div className="max-w-[840px] mx-auto">
                <Image className="w-full h-auto mb-5" src="/images/item_rfid/coda_rfid_s4.webp" alt={t("realtimePayment.alt")} width={1200} height={600} />
        ...
        <div className="w-full mb-[100px]">
          <FadeUpOnView delay={100}>
            <div className="py-[75px] md:py-[150px] px-4 max-w-7xl mx-auto text-center">
              ...
              <Image className="w-[470px] h-auto mb-5 mx-auto" src="/images/item_rfid/coda_rfid_s5.webp" alt={t("quickAccurate.alt")} width={1200} height={600} />
            </div>
          </FadeUpOnView>
          ...
          <FadeUpOnView delay={100}>
            <div className="py-[75px] px-4 max-w-7xl mx-auto text-center">
              ...
              <Image className="w-[470px] h-auto mb-5 mx-auto" src="/images/item_rfid/coda_rfid_s6.webp" alt={t("safeComfortable.alt")} width={1200} height={600} />
            </div>
          </FadeUpOnView>
        </div>
          ...
          <div className="py-[75px] md:py-[150px] px-4 max-w-7xl mx-auto text-center">
              ...
              <div className="flex flex-col md:flex-row my-10">
                <div className="md:w-1/2 flex items-center justify-end md:pr-[50px]">
                  <div className="text-right">
                    <Image width={50} height={50} className="inline-block mb-[10px]" src="/images/common/num1.webp" alt={t("collectionMethod.steps.0.numAlt")} />
                ...
                <div className="md:w-1/2">
                  <Image width={600} height={400} className="w-full h-auto" src="/images/item_rfid/coda_rfid_s8_1.webp" alt={t("collectionMethod.steps.0.alt")} />
                </div>
              </div>
            </FadeUpOnView>
              ...
              <div className="flex flex-col md:flex-row-reverse my-10">
                <div className="md:w-1/2 flex items-center justify-start md:pl-[50px]">
                  <div className="text-left">
                    <Image width={50} height={50} className="inline-block mb-[10px]" src="/images/common/num2.webp" alt={t("collectionMethod.steps.1.numAlt")} />
                ...
                <div className="md:w-1/2">
                  <Image width={600} height={400} className="w-full h-auto" src="/images/item_rfid/coda_rfid_s8_2.webp" alt={t("collectionMethod.steps.1.alt")} />
                </div>
              </div>
            </FadeUpOnView>
            ...
            <FadeUpOnView delay={200}>
              <div className="flex flex-col md:flex-row my-10">
                <div className="md:w-1/2 flex items-center justify-end md:pr-[50px]">
                  <div className="text-right">
                    <Image width={50} height={50} className="inline-block mb-[10px]" src="/images/common/num3.webp" alt={t("collectionMethod.steps.2.numAlt")} />
                ...
                <div className="md:w-1/2">
                  <Image width={600} height={400} className="w-full h-auto" src="/images/item_rfid/coda_rfid_s8_3.webp" alt={t("collectionMethod.steps.2.alt")} />
                </div>
              </div>
            </FadeUpOnView>
            ...
            <FadeUpOnView delay={300}>
              <div className="flex flex-col md:flex-row-reverse my-10">
                <div className="md:w-1/2 flex items-center justify-start md:pl-[50px]">
                  <div className="text-left">
                    <Image width={50} height={50} className="inline-block mb-[10px]" src="/images/common/num4.webp" alt={t("collectionMethod.steps.3.numAlt")} />
                ...
                <div className="md:w-1/2">
                  <Image width={600} height={400} className="w-full h-auto" src="/images/item_rfid/coda_rfid_s8_4.webp" alt={t("collectionMethod.steps.3.alt")} />
                </div>
              </div>
            </FadeUpOnView>
          </div>
        ...
        <div className="w-full">
          <div className="py-[75px] md:py-[150px] px-4 max-w-7xl mx-auto text-center">
            ...
            <Image className="w-[470px] h-auto py-[30px] mx-auto" src="/images/item_rfid/coda_rfid_s9.webp" alt={t("systemDiagram.diagramAlt")} width={1200} height={600} />
            ...
            <Image className="w-[470px] h-auto py-[30px] mx-auto" src="/images/item_rfid/coda_rfid_s10.webp" alt={t("systemDiagram.indicatorAlt")} width={1200} height={600} />
        ...
        {/* 푸터 이미지 */}
        <div className="w-full">
          <Image className="w-full h-auto" src="/images/item_rfid/coda_rfid_s11.webp" alt={t("header.finalAlt")} width={1920} height={600} />
        </div>
      </div>
    </div>
  );
