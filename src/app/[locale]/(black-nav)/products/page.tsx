    ...
    <div className="w-full">
      <div className="w-[1280px] mx-auto px-4">
        <div className="container mx-auto mt-[250px] mb-[150px]">
          <h1 className="text-4xl font-bold text-center text-gray-800 mb-[100px] pt-8">코다(CODA) 제품 라인업</h1>
              ...
              <li key={product.id} className="flex flex-col items-center">
                <Link href={product.href} className="group text-center transition-all duration-300 hover:scale-105">
                  <div className="flex flex-col items-center mb-4 overflow-hidden rounded-lg">
                    <Image src={product.image} width={256} height={320} alt={product.alt} className="w-[140px] h-auto object-cover transition-opacity duration-300 group-hover:opacity-75" />
                  </div>
